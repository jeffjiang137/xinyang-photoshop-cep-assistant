/* 鑫洋助理 v2.1.97 - 独立“嵌入下方图层”入口
 * 绕过长期驻留 CEP 会话中的旧 LongStitchCEP 方法表，避免“未知功能”。
 */
var XinyangEmbedLowerV2197 = $.global.XinyangEmbedLowerV2197 = (function () {
    var activeJob = null;
    ...
    function executeEmbed() {
        ...
        loadTransparencySelection(document, source);
    ...
    function invoke(payloadJson) {
        ...
        try {
            ...
            try {
                document.suspendHistory("鑫洋助理：嵌入下方图层", "XinyangEmbedLowerV2197._runJob()");
            } catch (historyError) {
                if (historyBefore) {
